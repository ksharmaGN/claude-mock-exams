...
export const topic5Questions: Question[] = [
  // Question 401 - Answer: B
  {
    ...
    option_a: 'Between one hundred and one hundred fifty lines maximum',
    option_b: 'Between two hundred and three hundred lines for optimal context efficiency',
    option_c: 'Between five hundred and six hundred lines allowing detailed specifications',
    option_d: 'No fixed limit add comprehensive content as needed for completeness',
    correct_answer: 'B',
