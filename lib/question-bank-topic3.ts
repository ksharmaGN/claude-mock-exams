...
export const topic3Questions: Question[] = [
  // Question 201 - Answer: B
  {
    ...
    option_a: 'Hooks are optional suggestions that Claude may skip during busy operations',
    option_b: 'Hooks execute deterministically on every event, while CLAUDE.md provides advisory guidance Claude may choose to follow',
    option_c: 'Hooks introduce 2-3 second latency making them impractical for production',
    option_d: 'CLAUDE.md instructions override hook configurations when conflicts occur',
    correct_answer: 'B',
  ...
  // Question 202 - Answer: C
  {
    ...
    option_a: 'PreToolUse - fires before each tool execution',
    option_b: 'PostToolUse - fires after tool completion',
    option_c: 'UserPromptSubmit - fires before Claude processes the user request',
    option_d: 'AgentHook - spawns a subagent to monitor requests',
    correct_answer: 'C',
