...
export const topic6Questions: Question[] = [
  // Question 501 - Answer: C
  {
    ...
    option_a: 'Execute changes across all 10 files immediately for speed',
    option_b: 'Skip the planning phase and go straight to commits',
    option_c: 'Analyze dependencies, draft a coordinated plan, and get approval before modifying any files',
    option_d: 'Bypass code review requirements and push directly to production',
    correct_answer: 'C',
  ...
  // Question 503 - Answer: D
  {
    ...
    option_b: 'All tools including Write and Edit to make quick fixes',
  ...
  // Question 509 - Answer: C
  {
    ...
    option_a: 'Task 1: Fixing a typo in README',
    option_b: 'Task 2: Renaming userId variable',
    option_c: 'Task 3: Refactoring complex multi-file authentication system',
    option_d: 'Task 4: Adding a console.log statement',
    correct_answer: 'C',
  ...
  // Question 520 - Answer: B
  {
    ...
    option_a: '1-2 turns (too restrictive)',
    option_b: '5-10 turns (balanced cost and thoroughness)',
    option_c: '50-100 turns (runaway costs)',
    option_d: 'Unlimited turns (potential budget disaster)',
    correct_answer: 'B',
  ...
  // Question 521 - Answer: C
  {
    ...
    option_a: 'Always use Claude Opus for best quality regardless of cost',
    option_b: 'Use the oldest model available to minimize cost',
  ...
  // Question 523 - Answer: D
  {
    ...
    option_a: 'It\'s not necessary - let jobs run to completion',
    option_b: 'Configure timeout-minutes to make workflows run faster',
    option_c: 'Set timeout to increase accuracy',
